...
export type MindProvider = 'groq' | 'openrouter' | 'gemini';

/** Extended-thinking budget mapping (kept for future use). */
...
export type ApiKeyName = 'elevenlabs' | 'groq' | 'openrouter' | 'gemini';
...
export const DEFAULT_SETTINGS: FlickySettings = {
  ...
  apiKeyStatus: { elevenlabs: false, groq: false, openrouter: false, gemini: false },
};
...
export const IPC = {
  ...
  LOCATE_ERROR: 'locate-error',
  CURSOR_POSITION: 'cursor-position',
  SETTINGS_CHANGED: 'settings-changed',
  PERMISSION_STATUS: 'permission-status',
  MEMORY_STATS: 'memory-stats',
  CHAT_ENTRY_ADDED: 'chat-entry-added',
  TOGGLE_TEXT_INPUT: 'toggle-text-input',
  ...
  SUBMIT_TEXT_INPUT: 'submit-text-input',
  CANCEL_TEXT_INPUT: 'cancel-text-input',
